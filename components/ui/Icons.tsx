...
export const GasStationIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16v-5.333c0-.84.62-1.558 1.458-1.644l.242-.026a2 2 0 012.299 1.693V16m0-4h2m2 4v-5.333c0-.84.62-1.558 1.458-1.644l.242-.026a2 2 0 012.299 1.693V16m-6-8h.01M12 4h.01M16 4h.01M6 20h12a2 2 0 002-2V8a2 2 0 00-2-2H6a2 2 0 00-2 2v10a2 2 0 002 2z" />
  </svg>
);
